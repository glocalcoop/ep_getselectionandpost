...
exports.clientVars = function( hook_name, args, cb ) {
  return cb({ "actions": settings.ep_copyselectionandpost.actions });
}
...
exports.eejsBlock_editbarMenuRight = function( hook_name, context, cb) {
  ...
  context.content = context.content + eejs.require("ep_copyselectionandpost/templates/editbarButtons.ejs");
  return cb();
}
...
exports.eejsBlock_dd_format = function ( hook_name, context, cb) {
  // console.log( hook_name, context );
  context.content = context.content + eejs.require("ep_copyselectionandpost/templates/fileMenu.ejs");
  return cb();
}
